...
def edit_profile(project_id: str, db_type: str, token: str, stub: SpaceCloudStub, _id: str, password: str,
                 new_email: Optional[str] = None, new_name: Optional[str] = None, new_password: Optional[str] = None):
    """
    ...
    return transport.edit_profile(stub, _id, password=password, new_email=new_email, new_name=new_name,
                                  new_password=new_password, meta=meta)
